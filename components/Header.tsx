    ...
    <header className="sticky top-0 z-50 backdrop-blur bg-white/70 border-b border-black/5">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
        <Link href="/" className="flex items-center gap-3">
          <img src="/logo-placev.png" alt="Place V Coworking" className="h-10 w-auto" />
        </Link>
        <nav className="hidden md:flex items-center gap-6 text-sm">
          ...
          <Link href="/contact" className="inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-placev-blue to-placev-mint px-4 py-2 text-white shadow-cta">
      ...
      {open && (
        <div className="md:hidden border-t border-black/5 px-4 py-3 space-y-3 bg-white/90">
          ...
          <Link href="/contact" className="block text-center rounded-2xl bg-gradient-to-r from-placev-blue to-placev-mint px-4 py-2 text-white">
            {SITE.primaryCTA}
          </Link>
        </div>
      )}
