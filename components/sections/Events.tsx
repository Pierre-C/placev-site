        ...
        <div data-testid="events-list" className="mt-8 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {events.map((event, i) => (
            <motion.div
              ...
              className="rounded-2xl border border-black/5 bg-white p-5 flex flex-col gap-3"
            >
              ...
              {event.registrationUrl && event.registrationUrl.trim() !== "" && (
                <a
                  ...
                  className="inline-block rounded-lg bg-blue-600 px-4 py-2 text-sm font-medium text-white text-center hover:bg-blue-700 transition"
                >
                  S'inscrire
                </a>
              )}
